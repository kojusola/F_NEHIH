      ...
      <div>
          ...
          <div class="aboslute flex items-center top-0 w-full h-full bg-black bg-opacity-80 bottom-0">
            <div class="text-center  hero text-light mx-auto py-20 space-y-3 animate-fade-in-down">
              <p class=" text-lg sm:text-3xl  font-bold text-white">
                Training Room
              </p>
            </div>
          </div>
          ...
          <div class="w-10/12 sm:w-10/12 mx-auto my-10">
               <div class="w-4/12 hidden sm:block  mx-auto mb-5">
                 <VueSlickCarousel ref="c1"
                  ...
                  >
                <div class="">
                  <img class="h-64 w-64 " src="../../assets/workspace/board_room.jpeg" alt="">
                </div>
                <div class="">
                  <img class="h-64 w-64" src="../../assets/workspace/board_room.jpeg" alt="">
                </div>
                ...
                :focusOnSelect="true">
                <div class="">
                  <img class="h-24 w-24 shadow-lg hover:shadow-2xl" src="../../assets/workspace/board_room.jpeg" alt="">
                </div>
                <div class="">
                  <img class="h-24 w-24 shadow-lg hover:shadow-2xl" src="../../assets/workspace/board_room.jpeg" alt="">
                </div>
            ...
            <div class="block sm:flex">
                ...
                <div class="sm:w-1/2 mt-4 sm:mt-0">
                     ...
                     <p class="text-xl topic text-lilac-light">    &#8358; 10,000 hourly</p> 
                </div>
            </div>   
            </div>
          </div>

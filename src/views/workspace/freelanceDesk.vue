      ...
      <div>
          ...
          <div class="aboslute flex items-center top-0 w-full h-full bg-black bg-opacity-80 bottom-0">
            <div class="text-center  hero text-light mx-auto py-20 space-y-3 animate-fade-in-down">
              <p class=" text-lg sm:text-3xl  font-bold text-white">Freelance Desk</p>
            </div>
          </div>
        </div>
      <div>
          <div class="w-10/12 sm:w-10/12 mx-auto my-10">
               <div class="w-4/12 hidden sm:block  mx-auto mb-5">
                 <VueSlickCarousel ref="c1"
                  :asNavFor="$refs.c2"
                  :focusOnSelect="true"
                  >
                <div class="">
                  <img class="h-64 w-64 " src="../../assets/workspace/freelance-desk-2.jpeg" alt="">
                </div>
                <div class="">
                  <img class="h-64 w-64" src="../../assets/workspace/freelance-desk-2.jpeg" alt="">
                </div>
                ...
                :focusOnSelect="true">
                <div class="">
                  <img class="h-24 w-24 shadow-lg hover:shadow-2xl" src="../../assets/workspace/freelance-desk-2.jpeg" alt="">
                </div>
                <div class="">
                  <img class="h-24 w-24 shadow-lg hover:shadow-2xl" src="../../assets/workspace/freelance-desk-2.jpeg" alt="">
                </div>
            ...
            <div class="">
                    ...
                    <ul class="">
                        <li class="my-1">Designated Workspace</li>
                        ...
                        <li class="my-1">3 hrs Training Room</li>
                        <li class="my-1">5 hrs Conference Room</li>
                        <li class="my-1">Open events</li>
                    </ul>
                    <p class="text-xl topic text-lilac-light">Fees: &#8358; 45,000 Monthly </p>   
            </div> 
            </div>
          </div>
      <Footer/>
...
.bgimage{
    height: 300px;
    background-image: url("../../assets/background/coworking.jpg");
